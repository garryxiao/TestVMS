...
const routers = [
  ...
  { component: VehicleAdd, label: 'Add a Vehicle', path: '/vehicle/add', exact: true },
  { component: VehicleAdd, label: 'Edit Vehicle', path: '/vehicle/edit/:id' },
  { component: VehicleSearch, label: 'Vehicles', path: '/vehicle/search', search: true },
